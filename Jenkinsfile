          ...
          stage('test ssh') {
             steps {
                ...
                sh '''             
                    ...
                    for file in $(find .); do echo $file;
                    for file in $(find .); do scp -c -t -o StrictHostKeyChecking=no $file alquimista@ec2-3-225-222-165.compute-1.amazonaws.com:/home/alquimista/scratch; done
