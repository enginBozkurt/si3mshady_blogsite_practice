          ...
          stage('test ssh') {
             steps {
                ...
                sh '''             
                    ...
                    for file in $(find .); do sudo scp  -v -t -o StrictHostKeyChecking=no -c \
                    /var/jenkins_home/workspace/Si3mshady-Blogsite-CICD_dev/$file alquimista@ec2-3-225-222-165.compute-1.amazonaws.com:/home/alquimista/; done
